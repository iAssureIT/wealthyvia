...
class Login extends Component {
  ...
  userlogin(event){
    event.preventDefault();
     console.log("in login mode",this.state.email, this.state.pwd);
        var auth= {
    ...
    axios
      .post('/api/users/post/login/distributor',auth)
      .then((response)=> {
        ...
        }else if(response.data.message == "User Not found Or User is not a distributor"){
          ...
          if(response.data){
            ...
            if(response.data.passwordreset){
             ...
             this.props.history.push("/dashboard");
              ...
              localStorage.setItem("tokenbackup",response.data.token);   
              //swal("token",localStorage.getItem('tokenbackup'));           
          ...
          <div className="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-12 signupPadding signUpFormWrap " style={{"height": divHeight}}>
            <div className="divLoginInWrap">
              <form id="login" onSubmit={this.userlogin.bind(this)}>
                ...
                <h4 className="signInNameTitle "><span className="bordbt">Hi Partner, </span></h4>
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 paddingZero">
                  <div className="inputContent">
                    <span className="blocking-span noIb">
                      <input type="email" className="form-control border3 pass oesSignUpForm tmsLoginTextBox oesSignUpForm tmsLoginTextBox" onChange={this.handleChange.bind(this)} ref="loginusername" id="loginusername" name="email" placeholder="" value={this.state.email} required/>
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 marBtm30 paddingZero">
                  <div className="form-group form-group1 fltlft input-group col-lg-12 col-md-12 col-sm-12 inputContent ">     
                    <span className="blocking-span noIb">
                      <input type="password" className="form-control border3 pass oesSignUpForm confirmbtm inputTextPass tmsLoginTextBox" onChange={this.handleChange.bind(this)} ref="loginpassword" name="pwd" value={this.state.pwd} required/>
