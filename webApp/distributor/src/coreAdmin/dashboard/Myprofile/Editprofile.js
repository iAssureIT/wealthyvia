        ...
        .then((res)=>{
          var DistributorData = res.data
            ...
            var fields2 = {
              ...
              "aadharnumber"  : DistributorData.aadharnumber,
              "pannumber"     : DistributorData.pannumber,
              "accountnumber" : DistributorData.accountnumber,
              "bankname"      : DistributorData.bankname,
              "branchname"    : DistributorData.branchname,
              "IFSCcode"      : DistributorData.IFSCcode,
              "MICRcode"      : DistributorData.MICRcode,           
            };
      ...
      <div>
          <div>   
            ...
            <section className=" viewContent ">
              <div className="row">
                <div className="col-lg-10 col-md-12 col-xs-12 col-sm-12 mheight ">                
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12   marginT ">
                      <h4 className="HeadDistributer">Edit Profile</h4>
                   <hr/>
                   </div>        
