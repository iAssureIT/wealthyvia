...
handleSubmit(event){
  // event.preventDefault();
  console.log("this.state.fileUpload.length < 0",this.state.fileUpload.length,this.state.fileUpload);
    if(this.state.title === '' || this.state.url === ''|| this.state.fileUpload.length <= 0){
   ...
   console.log("dataArray1", this.state.portfolioImage1);
    axios
      ...
      .then((response) =>{
        ...
        swal("Uploaded", "video URl Upload successfully"+  "success" );
...
update(event){
  ...
  .then((res)=>{
    console.log("res",res);
              swal("Uploaded","Your Tools Data Update successfully","success");
               this.props.history.push("/tools");
                this.getUrl();
          })
          .catch((error)=>{
      ...
      // console.log("this.state.portfolioImage1",this.state.fileUpload);
        ...
        <div>
          <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 mheight">                
            ...
            <div className="col-lg-4 col-sm-12 col-xs-12 col-md-12 setMb nppadding">  
              ...
              <div className=" col-lg-12 col-md-10 col-xs-12 col-sm-12 inputContent ">
                <input type="text"  className="form-control inputText form-control has-content" name="title" ref="title" 
                    data-text="title"
            ...
            <div className="col-lg-4 col-sm-12 col-xs-12 col-md-12 nppadding setMb">  
              <div className=" col-lg-10 col-md-10 col-xs-12 col-sm-12 inputContent">
            ...
            <div className="col-lg-7 col-lg-offset-2 col-md-6 col-xs-12  col-sm-2 nopadding ">
                <div className="col-lg-1 col-md-12 col-sm-12 col-xs-12 row pull-right nopadding setMarginRight">
            ...
            <div className="col-lg-12   col-sm-12 col-xs-12 col-md-12 ml45 mt20 ">  
              {
                this.state.submit 
                ?
                ...
                <table className="table table-bordered tableCustom table-striped reserachtable">
                  <thead>
                    <tr>
                      ...
                      <th className="text-center">Upload Youtube Video </th>
                        ...
                        this.state.videoData.map((data, index)=>{
                          return(
                            <tr key={index}>
                              ...
                              <td >
                                 <a target="_blank"><ReactPlayer url={data.url} width='100px' height='70px' target="_blank" controls loop  /></a>
                              </td>
                              <td className="td_pdf">
                                {data.fileUpload 
                                  ?
