...
if(s3Data){
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const CategoryIcon = new FilesCollection({
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'CategoryIcon/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = CategoryIcon.remove;
            CategoryIcon.remove = function(search) {
