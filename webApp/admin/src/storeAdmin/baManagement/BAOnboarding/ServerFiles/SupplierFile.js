...
if(s3Data){
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const SupplierFile = new FilesCollection({
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'SupplierFile/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = SupplierFile.remove;
            SupplierFile.remove = function(search) {
