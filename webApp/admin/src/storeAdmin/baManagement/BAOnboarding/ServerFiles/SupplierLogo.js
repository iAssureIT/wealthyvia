...
import { ProjectSettings } from '/imports/Common/ProjectSettings/projectSettings.js';
import { S3Details } from '/imports/Common/s3Details.js';
...
if(s3Data){
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const SupplierLogo = new FilesCollection({
                debug          : false, // Change to `true` for debugging
                storagePath    : 'SupplierLogo',
                collectionName : 'supplierLogo',
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'SupplierLogo/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = SupplierLogo.remove;
            SupplierLogo.remove = function(search) {
