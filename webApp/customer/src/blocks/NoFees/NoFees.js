...
export default class NoFees extends Component {
  ...
  render() {
    ...
    return (
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 backColorWhite mt20 padding40" id="5gcpm">
              <div className="row">
               ...
               <div className="col-lg-6 col-lg-offset-6 col-md-6  hidden-sm hidden-xs fiveG para1">
                  <div>
