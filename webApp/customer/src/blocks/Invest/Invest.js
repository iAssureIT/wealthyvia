            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 backColorPurple investContainer">
              <div className="row">
                ...
                <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 subDiv1 ">
                    ...
                    <label className="payZero">Pay zero Wealthyvia fees.</label>
                ...
                <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 subDiv1 ">
                 ...
                 <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 subDiv1 ">
                    ...
                    <p className="payZeroDesc">Wealthyvia is built for those who learn by doing—because the fastest way to become an investor is to start investing.</p>
