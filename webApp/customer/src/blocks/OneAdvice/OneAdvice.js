              ...
              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 backColorWhite">
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 oneOnOneAdvice">
                    ...
                    <p>Thinking about buying a home? Just graduated and curious about how to invest while paying off student loan debt? We can help with that. SoFi members get one-on-one access to financial advisors so you can make a plan to tackle your goals.</p>
                  </div>
