						 	...
						 	<div className="item">
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 imgContainerBlog ">
									<div className="row">
										...
										<p>Perceptions are good and helps us to avoid big accidents. They are in our genetics & investing is not above it...<br/><a href="https://www.arthavruddhi.com/blog"> read more</a></p>
									</div>
								</div>
							</div>
							 <div className="item ">
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 imgContainerBlog ">
									<div className="row">
										...
										<p>This is one of major reforms in Indian business ecosystem after 1991...<br/><a href="https://www.arthavruddhi.com/blog"> read more</a></p>
									</div>
								</div>
							</div>
							 <div className="item ">
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 imgContainerBlog ">
									<div className="row">
										...
										<p>In 2014 , I met an old investor. I had no clue what was his portfolio or profile. We explained him a midcap idea he listened patiently...<a href="https://www.arthavruddhi.com/blog"> read more</a></p>
									</div>
								</div>
							</div>
