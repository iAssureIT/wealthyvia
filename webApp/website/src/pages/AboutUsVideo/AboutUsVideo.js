        ...
        <div className="col-lg-12 nopadding AllBlogsbannerWall">
          <div className="col-lg-12 AllBlogscentered">
            <div  className="col-lg-6 pull-right">
              <div className="outerborder col-lg-5 setSizeResponsive pull-right noPadding">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 toolsDate setPaddingLeft">
                  ...
                  <div className="tab-content col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                    <div className="tab-pane" id="Daily">
                      <div className="marginStyle col-lg-12 nopadding">
                        <div className="col-lg-12 col-md-6 col-sm-12 col-xs-12 searchBoxBugt margintopReport">
                          ...
                          <input type="date" className="todaysdate setBackground col-lg-4 col-md-4 col-sm-8 col-xs-8" name="todayDate" id="todayDate" onChange={this.handleChange.bind(this)} value={this.state.todayDate}/>
                    ...
                    <div className="tab-pane active" id="Monthly">
                      <div className="marginStyle col-lg-12 col-md-12 col-sm-12 col-xs-12 setResponsive searchBoxBugt  margintopReport nopadding monthfieldright">
                        ...
                        <input type="month" className="todaysdate setBackground col-lg-8 col-md-8 col-sm-8 col-xs-8 nopadding lineheightdate" name="monthlyValue" id="monthlyValue" onChange={this.handleChange.bind(this)} value={this.state.monthlyState} />
