					...
					<div className="divLoginInWrap">
						...
						<form id="signUpUser" onSubmit={this.usersignup.bind(this)}>
							...
							<div className="col-lg-12 col-md-12  signUpInnerWrapperOES signupfrm">
								...
								<div className="form-group form-group1 col-lg-12 col-md-12 col-xs-12 col-sm-12 inputContent boxMarg">
										<span className="blocking-span noIb">   
										  <input type="referredby" className="form-control signupsetting toLowerCase abacusTextbox oesSignUpForm" ref="referredby" name="referredby" onChange={this.handleChange} data-text="referredbyV" required/>
										  {this.state.errors.referredbyV  && (
					                        <span className="text-danger">{this.state.errors.referredbyV}</span> 
					                      )}
								    		<span className="floating-label"><i className="fa fa-envelope-o signupIconFont" aria-hidden="true"></i>Referred by</span>					   			
										</span>
								</div>
